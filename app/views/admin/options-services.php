...
if (isset($_POST['submit']) && csrf_filter()) {
	...
	Config::set('services.sparkpost', array(
		'secret' => escape($_POST['sparkpost']['secret'])
	));
...
<div class="row">
	<div class="col-md-6">
		...
		<form action="" method="POST">
		    ...
		    <hr>
	        <div class="form-group clearfix">
	            <label for="sparkpost">SparkPost</label>
	            <div class="input-group">
	    			<span class="input-group-addon">secret</span>
	    	        <input type="text" name="sparkpost[secret]" id="sparkpost" value="<?php echo Config::get('services.sparkpost.secret') ?>" class="form-control">
	            </div>
	        </div>
			<hr>
...
<style>
	...
	.input-group-id .input-group-addon { padding-left: 20px; padding-right: 20px; }
