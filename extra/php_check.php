...
<body>
	<div class="container">
		...
		if (version_compare(PHP_VERSION, '5.3.7', '<')) {
			echo '<div class="alert error"><b>PHP Version:</b> '.PHP_VERSION.' <br> Minimum: 5.3.7.</div>';
		} elseif (version_compare(PHP_VERSION, '5.4.0', '<')) {
			echo '<div class="alert warning"><b>PHP Version:</b> '.PHP_VERSION.' <br> You can run the script but without the mail api drivers. <br> Minimum: 5.4.0.</div>';
		} else {
			echo '<div class="alert success"><b>PHP Version:</b> '.PHP_VERSION.'.</div>';
		}

		if (extension_loaded('pdo_mysql')) {
			echo '<div class="alert success">PDO extension loaded.</div>';
		} else {
			echo '<div class="alert error"><a href="http://php.net/manual/en/book.pdo.php" target="_blank">PDO</a> extension required.</div>';
		}
		...
		if (extension_loaded('mbstring')) {
			echo '<div class="alert success">Mbstring extension loaded.</div>';
		} else {
			echo '<div class="alert error"><a href="http://php.net/manual/en/book.mbstring.php" target="_blank">Mbstring</a> extension required.</div>';
		}
